...
const routes: Routes = [
  ...
  { path: 'modifyCategorie/:id', loadChildren: () => import('./pages/modify-categorie/modify-categorie.module').then(m => m.ModifyCategorieModule) },
  ...
  { path: 'modifySousCategorie/:id', loadChildren: () => import('./pages/modify-sous-categorie/modify-sous-categorie.module').then(m => m.ModifySousCategorieModule) },
